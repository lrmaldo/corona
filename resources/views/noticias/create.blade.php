...
// Centramos el mapa en las coordenadas obtenidas
  ...
  <h1 class="mt-4">Crear Caso</h1>
              ...
              <form  role="form" method="POST" enctype="multipart/form-data" action="{{ url('/noticias/store') }}">
                ...
                <div class="input-group-prepend">
                  ...
                  <div class="col-md-8">
                    <input type="text" id ="titulo" class="form-control" name="titulo" value="" placeholder="Escribe el titulo de la noticia" required>
                  </div>
                </div>
                ...
                <div class="input-group-prepend">
                  ...
                  <div class="col-md-8">
                  <textarea  id="resumen"  rows="5" cols="50" class="form-control" name="resumen" placeholder="Escribe un resume para la noticia en la app"  required></textarea>
                  </div>
                </div> 
                <div class="form-group">
                <div class="input-group-prepend">
                ...
                <div class="input-group-prepend">
                  ...
                  <div class="col-md-8">
                  <input type="text" class="form-control" name="url_noticia" required  >
                  </div>
                </div>  
